...
export class InitialMigration1685560674108 implements MigrationInterface {
    name = 'InitialMigration1685560674108'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "users" ("id" SERIAL NOT NULL, "name" character varying(127) NOT NULL, "email" character varying(127) NOT NULL, "password" character varying(255) NOT NULL, "cpf" character varying(11) NOT NULL, "cellphone" character varying(11) NOT NULL, "birth_date" date NOT NULL, "description" text, "is_seller" boolean NOT NULL DEFAULT false, "is_admin" boolean NOT NULL DEFAULT false, "created_at" date NOT NULL DEFAULT now(), "updatedAt" date NOT NULL DEFAULT now(), "deletedAt" date, CONSTRAINT "UQ_97672ac88f789774dd47f7c8be3" UNIQUE ("email"), CONSTRAINT "UQ_230b925048540454c8b4c481e1c" UNIQUE ("cpf"), CONSTRAINT "PK_a3ffb1c0c8416b9fc6f907b7433" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "adresses" ("id" SERIAL NOT NULL, "cep" character varying(8) NOT NULL, "uf" character varying(2) NOT NULL, "city" character varying(50) NOT NULL, "street" character varying(255) NOT NULL, "number" character varying(10) NOT NULL, "complement" text, "userId" integer, CONSTRAINT "REL_b4f5c94493f23641866f161e21" UNIQUE ("userId"), CONSTRAINT "PK_2787c84f7433e390ff8961d552d" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TYPE "public"."adverts_fuel_type_enum" AS ENUM('Flex', 'Híbrido', 'Elétrico')`);
        await queryRunner.query(`CREATE TABLE "adverts" ("id" SERIAL NOT NULL, "brand" character varying(127) NOT NULL, "model" character varying(255) NOT NULL, "year" integer NOT NULL, "fuel_type" "public"."adverts_fuel_type_enum" NOT NULL DEFAULT 'Flex', "mileage" character varying(50) NOT NULL, "color" character varying(20) NOT NULL, "fipe_price" numeric NOT NULL, "price" numeric NOT NULL, "description" text NOT NULL, "cover_image" character varying(255) NOT NULL, "is_published" boolean NOT NULL DEFAULT true, "created_at" date NOT NULL DEFAULT now(), "deletedAt" date, "updatedAt" date NOT NULL DEFAULT now(), "userId" integer, CONSTRAINT "PK_36876931b51109a932d0bf3b40a" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "comment_advert_users" ("id" SERIAL NOT NULL, "comment" text NOT NULL, "userId" integer, "advertId" integer, CONSTRAINT "PK_37749ea44760c28131b39310909" PRIMARY KEY ("id"))`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`DROP TYPE "public"."adverts_fuel_type_enum"`);
