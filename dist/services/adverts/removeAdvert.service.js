...
const removeAdvertService = (advertId) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const advert = Object(yield advertRepository.findOneBy({
        id: advertId
    }));
    yield galleryImagesRepository.delete({ advert: advert });
    yield advertRepository.remove(advert);
});
exports.default = removeAdvertService;
